...
addTechBtn.addEventListener('click', function(ev){
    ...
    const expRadio2 = createInput(id1, '0-2 anos', 'techExp-'+rowIndex, 'radio')
    const expLabel2 = createLabel('3-5 anos', id2)

    const id3 = 'expRadio-'+rowIndex+'.3'
    const expRadio3 = createInput(id1, '0-2 anos', 'techExp-'+rowIndex, 'radio')
    const expLabel3 = createLabel('6-8 anos', id3)
